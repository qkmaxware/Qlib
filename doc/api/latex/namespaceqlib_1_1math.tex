...
Multiply two matrices \index{qlib\+::math@{qlib\+::math}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!qlib\+::math@{qlib\+::math}}
...
Scale up a matrix by a scalar quantity \index{qlib\+::math@{qlib\+::math}!operator+@{operator+}}
